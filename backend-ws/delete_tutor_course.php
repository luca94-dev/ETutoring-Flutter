...
try {
	...
	$sql = "DELETE FROM tutor_course WHERE user_id = '$user_id' AND course_id =' $course_id'";
	if($connect->query($sql)){
		$SuccessMSG = json_encode("Course successfully deleted");
		echo $SuccessMSG ; 
	} else {
		$InvalidMSG = "Error deleting course";
