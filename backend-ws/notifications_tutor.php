...
if($_GET['email']){
	...
	$sql = "SELECT *, private_lesson.user_id as student_id FROM notifications_tutor 
	JOIN private_lesson ON notifications_tutor.private_lesson_id = private_lesson.private_lesson_id
	...
	where tutor_course.user_id = '" . $user_id ."' ORDER BY notifications_tutor.date DESC";
